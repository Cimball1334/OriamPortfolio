...
REQUIRED_DEFNS = ["findRecommendations",
                  "compressInfo",
                  "combineInfo",
                  "setofNames"
                  ]
...
############################################################################
	def test_findRecommendations_1 (self):
		matches = ["JS", "M", 90, "MS", "M", 76, "JB", "M", 89, "TM", "M", 79]
		findRecommendations(matches)
		self.assertEqual(matches, [['JS', 'M', 90, '♥'], ['JB', 'M', 89]])
	
	def test_findRecommendations_2 (self):
		matches = ["JS", "M", 90, "MS", "F", 76, "JB", "M", 89, "TM", "F", 79, "GM", "M", 100, "AB", "F", 65, "SK", "F", 88]
		findRecommendations(matches) 
		self.assertEqual(matches, [['JS', 'M', 90], ['JB', 'M', 89], ['GM', 'M', 100, '♥'], ['SK', 'F', 88]])
	
	def test_findRecommendations_3 (self):
		matches = ["JS", "M", 50, "MS", "F", 46, "JB", "M", 68, "TM", "F", 50, "GM", "M", 30, "SK", "F", 33]
		findRecommendations(matches) 
		self.assertEqual(matches, [])
############################################################################
	def test_compressInfo_1  (self):
		datingTrack = [["B111", "10/2/2022"], ["B111", "9/25/2022"], ["B222", "8/1/2022"], ["B111", "9/2/2022"]]
		compressInfo(datingTrack) #nothing is returned!
		self.assertEqual(datingTrack, [('B111', 3), ('B222', 1)])
	
	def test_compressInfo_2  (self):
		datingTrack = [["B111", "10/2/2022"], ["B111", "9/25/2022"], ["B111", "8/1/2022"], ["B111", "9/2/2022"]]
		compressInfo(datingTrack) #nothing is returned!
		self.assertEqual(datingTrack, [('B111', 4)])
	
	def test_compressInfo_3  (self):
		datingTrack = [["B111", "10/2/2022"], ["B222", "9/25/2022"], ["B333", "8/1/2022"], ["B444", "9/2/2022"]]
		compressInfo(datingTrack) #nothing is returned!
		self.assertEqual(datingTrack, [('B111', 1), ('B222', 1), ('B333', 1), ('B444', 1)])

############################################################################
	def test_combineInfo_1  (self):
		profileInfo = [["Stephanie Jones", "B001"], ["Judith Schmitt", "B002"]]
		datingTrack = [("B002", 3),("B001", 5)]
		combineInfo(profileInfo, datingTrack) #nothing is returned!
		self.assertEqual(profileInfo, [['Stephanie Jones', 'B001', 5], ['Judith Schmitt', 'B002', 3]])
	
	def test_combineInfo_2  (self):
		profileInfo = [["Anahi Saunders", "B111"], ["Thaddeus Huff", "B222"], ["Deven Holden", "B333"]]
		datingTrack = [("B111", 4),("B333", 2)]
		combineInfo(profileInfo, datingTrack) #nothing is returned!
		self.assertEqual(profileInfo, [['Anahi Saunders', 'B111', 4], ['Thaddeus Huff', 'B222'], ['Deven Holden', 'B333', 2]])
	
	def test_combineInfo_3  (self):
		profileInfo = [["Anahi Saunders", "B111"], ["Thaddeus Huff", "B222"], ["Deven Holden", "B333"]]
		datingTrack = [("B444", 4),("B555", 2)]
		combineInfo(profileInfo, datingTrack) #nothing is returned!
		self.assertEqual(profileInfo, [['Anahi Saunders', 'B111'], ['Thaddeus Huff', 'B222'], ['Deven Holden', 'B333']])
	
############################################################################
	def test_setofNames_1  (self):
		profiles = {
			"B111" : ["Anahi Saunders", "703-222-2222", "Fairfax"],
			"B222" : ["Thaddeus Huff", "202-111-1111", "Washington DC"],
			"B333" : ["Deven Holden", "703-333-3333", "Vienna"],
			"B444" : ["Cale Day", "703-545-5454", "Chantilly"],
			"B555" : ["Kenley Hartman", "703-333-3445", "Alexandria"],
			"B666" : ["Giovanni Ruiz", "703-111-1111", "Alexandria"],
			"B777" : ["Kamari Knox", "202-123-4567", "Washington DC"],
			"B888" : ["Kael Barr", "202-134-3333", "Washington DC"],
			"B999" : ["Catalina Colon", "703-356-3456", "Fairfax"],
			"B010" : ["Jasiah Fritz", "202-334-4567", "Fairfax"]
			}
        
		x = setofNames(profiles, "Fairfax")
		self.assertEqual(x, {'Catalina Colon', 'Anahi Saunders', 'Jasiah Fritz'})
        
	def test_setofNames_2  (self):
		profiles = {
			"B111" : ["Anahi Saunders", "703-222-2222", "Fairfax"],
			"B222" : ["Thaddeus Huff", "202-111-1111", "Washington DC"],
			"B333" : ["Deven Holden", "703-333-3333", "Vienna"],
		...
		x = setofNames(profiles, "Washington DC")
		self.assertEqual(x, {'Kael Barr', 'Thaddeus Huff', 'Kamari Knox'})
        
	def test_setofNames_3  (self):
		profiles = {
			"B111" : ["Anahi Saunders", "703-222-2222", "Fairfax"],
			"B222" : ["Thaddeus Huff", "202-111-1111", "Washington DC"],
			"B333" : ["Deven Holden", "703-333-3333", "Vienna"],
		...
		x = setofNames(profiles, "Chantilly")
		self.assertEqual(x, {'Cale Day'})
